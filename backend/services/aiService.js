...
9. For algorithm coding questions:
   ...
   - Test inputs must be valid, language-compatible, diverse, non-duplicated, including normal, edge, and boundary cases.
10. For "technical" questions:
   - evaluationType must be "spoken"
   - language, starterCode, referenceSolution, and testInputs must be null or omitted.
11. For "hr" questions:
   - evaluationType must be "spoken"
   - language, starterCode, referenceSolution, and testInputs must be null or omitted.
